...
namespace Sol_Capa_Presentacion.Clientes
{
    public partial class Frm_Clientes : Form
    {
        ...
        public void Listado_cl(string ctexto)
        {
            try
            {
        ...
        private void Seleccionar_Item()
        {
            ...
            else
            {
                ...
                txtNro_Documento_cl.Text = Convert.ToString(Dgv_Principal.CurrentRow.Cells["nrodocumento_cl"].Value);
                txtrazon_social.Text = Convert.ToString(Dgv_Principal.CurrentRow.Cells["razon_social_cl"].Value);
                ...
                txtEmail.Text = Convert.ToString(Dgv_Principal.CurrentRow.Cells["email_cl"].Value);
                txtTelefono.Text = Convert.ToString(Dgv_Principal.CurrentRow.Cells["telefono_cl"].Value);
                txtmovil.Text = Convert.ToString(Dgv_Principal.CurrentRow.Cells["movil_cl"].Value);
                ...
                txtDireccion.Text = Convert.ToString(Dgv_Principal.CurrentRow.Cells["direccion_cl"].Value);
                ...
                txtObservaciones.Text = Convert.ToString(Dgv_Principal.CurrentRow.Cells["observacion_cl"].Value);
        ...
        public void Listado_tdpc_cl(string ctexto)
        {
            try
            {
                Dgv_Tdpc.DataSource = N_Clientes.Listado_tdpc_cl();
                this.Formato_tdpc_cl();
            }
            catch (Exception ex)
            {
        ...
        private void Seleccionar_Item_tdpc_cl()
        {
        ...
        public void Listado_sx_cl()
        {
            try
            {
                Dvg_Genero.DataSource = N_Clientes.Listado_sx_cl();
                this.Formato_sx_cl();
            }
            catch (Exception ex)
            {
        ...
        private void Seleccionar_Item_sx_cl()
        {
        ...
        public void Listado_ru_pv(string ctexto)
        {
            try
            {
                Dvg_Rubros.DataSource = N_Clientes.Listado_ru_cl(ctexto);
                this.Formato_ru_cl();
            }
            catch (Exception ex)
            {
        ...
        private void Seleccionar_Item_ru_cl()
        {
        ...
        public void Listado_di_pv(string ctexto)
        {
            try
            {
                Dvg_Distritos.DataSource = N_Clientes.Listado_di_cl(ctexto);
                this.Formato_di_cl();
            }
            catch (Exception ex)
            {
        ...
        private void Seleccionar_Item_di_cl()
        {
        ...
        {
            txtNro_Documento_cl.Enabled = !lestado;            
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (opcion == DialogResult.Yes)
                {
                    string respuesta = "";
                    this.codigo_cl = Convert.ToInt32(Dgv_Principal.CurrentRow.Cells["codigo_cl"].Value);
                    respuesta = N_Clientes.Eliminar_cl(this.codigo_cl);
        ...
        private void btnGuardar_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                oCl.NroDocumento_cl = txtNro_Documento_cl.Text.Trim();
                oCl.Razon_Social_cl = txtrazon_social.Text.Trim();
                oCl.Nombre = txtNombre.Text.Trim();
                oCl.Apellidos = txtApellido.Text.Trim();
                oCl.codigo_sx = this.codigo_sx;
                oCl.codigo_ru = this.codigo_ru;
                oCl.email_cl = txtEmail.Text.Trim();
                oCl.telefono_cl = txtTelefono.Text.Trim();
                oCl.movil_cl = txtmovil.Text.Trim();
                oCl.direccion_cl = txtDireccion.Text.Trim();
                oCl.codigo_di = this.codigo_di;
                oCl.observaciones_cl = txtObservaciones.Text.Trim();

                respuesta = N_Clientes.Guardar_cl(estadoGuarda, oCl);
                if (respuesta == "ok")
                {
                    this.Listado_cl("%");
